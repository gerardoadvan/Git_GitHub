  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: null,
        title: Text("Zapatos de Tacón", style: TextStyle(color: Colors.black, fontSize: 25),),
        actions: <Widget>[
          IconButton(
            onPressed: () {},
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1100), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Teniss", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1200), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Futbol Americano", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeInUp(duration: Duration(milliseconds: 1300), child: Container(
                        margin: EdgeInsets.only(right: 10),
                        child: Center(
                          child: Text("Football Soccer", style: TextStyle(fontSize: 17),),
                        ),
                      )),
                    ),
                    AspectRatio(
